...
import './Navbar.css';
import { FaSteam, FaChevronDown } from 'react-icons/fa';
        ...
        <div className="navbar-container">
          <div className="navbar-left">
            ...
            <div className="logo-social-links">
              <a href="https://discord.gg/cs2market" target="_blank" rel="noopener noreferrer" className="logo-social-link" title="Join our Discord">
              ...
              <a href="https://facebook.com/CS2MarketOfficial" target="_blank" rel="noopener noreferrer" className="logo-social-link" title="Follow us on Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
